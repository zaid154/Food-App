            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="grid gap-6 lg:grid-cols-[1.5fr_0.8fr]">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="inline-flex items-center rounded-full border border-slate-200 bg-white">
                                                    <button
                                                        ...
                                                        className="h-9 w-9 rounded-l-full text-lg font-bold text-slate-700 transition hover:bg-slate-100"
                                                    >
                                                        −
                                                    </button>
                                                    ...
                                                    <button
                                                        ...
                                                        className="h-9 w-9 rounded-r-full text-lg font-bold text-slate-700 transition hover:bg-slate-100"
                                                    >
                                                        +
                                                    </button>
                                                </div>
                                                <button
                                                    ...
                                                    className="rounded-full bg-red-500 px-4 py-2 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-red-600"
                                                >
                                                    Remove
                                                </button>
                                            </div>
                    ...
                    <aside className="h-fit rounded-[30px] bg-slate-900 p-6 text-white shadow-[0_24px_70px_rgba(15,23,42,0.22)] md:p-7">
                        ...
                        <Link
                            to="/checkout"
                            className="mt-8 block w-full rounded-full bg-orange-400 px-6 py-4 text-center text-base font-bold text-slate-950 transition hover:-translate-y-0.5 hover:bg-orange-300"
                        >
                            Proceed to checkout
                        </Link>
