      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/" className="text-sm text-gray-400 hover:text-red-500 transition-colors">Home</a></li>
            <li><a href="/About" className="text-sm text-gray-400 hover:text-red-500 transition-colors">About Us</a></li>
            <li><a href="/Contact" className="text-sm text-gray-400 hover:text-red-500 transition-colors">Contact Us</a></li>
            <li><a href="/Cart" className="text-sm text-gray-400 hover:text-red-500 transition-colors">Cart</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><span className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">Restaurant Listing</span></li>
            <li><span className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">Menu Management</span></li>
            <li><span className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">Bulk Orders</span></li>
            <li><span className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">Party Orders</span></li>
            <li><span className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">Cloud Kitchen</span></li>
          </ul>
        </div>
